...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_FILES['receipt'])) {
  $bill_id = $_POST['bill_id']; // Ensure this field is included in your form
  $targetDir = "images/"; // Target directory for uploaded files
      ...
      if ($_FILES["receipt"]["size"] > 5000000) {
        $_SESSION['message'] = "Sorry, your file is too large.<br>";
          ...
          if (move_uploaded_file($_FILES["receipt"]["tmp_name"], $targetFilePath)) {
              // Prepare SQL query to insert the file path into the database
