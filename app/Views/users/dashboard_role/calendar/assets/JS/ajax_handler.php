...
if (isset($_GET['action'])) {
    ...
    if ($_POST['action'] == "insertEvent") {
        insertEvent($_POST['eventName'], $_POST['startDate'], $_POST['endDate'], $_POST['userID'], $_POST['email'], $_POST['emailMsg']);
    ...
    if ($_POST['action'] == "updateEvent") {
        ...
        updateEvent($_POST['eventName'], $_POST['startDate'], $_POST['endDate'], $_POST['event_id'], $_POST['userID'], $_POST['email'], $_POST['emailMsg']);
