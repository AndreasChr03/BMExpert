...
<body class="sb-nav-fixed">
            ...
            <div class="select-month" style="padding: 8px 16px;">
                <div class="button-container">
                    ...
                    <form id="monthForm" style="flex-grow: 1; display: flex; justify-content: center; align-items: center;">
                        <button type="button" class="btn btn-secondary" onclick="window.location.href='dashboard_admin_reports.php';">
                        ...
                        <button type="button" onclick="fetchData()" class="btn btn-primary" style="border: 1px solid #086972; background-color: #086972; color: white; height: 40px;">Generate Report</button>
                    </form>
    ...
    <!-- <div class="col-xl-6">
            <div class="card mb-6">
                ...
                <canvas id="myChart" style="height: 100%; width: 40%;"></canvas>
                </div>                   
            </div>
        </div> -->
    </div>
