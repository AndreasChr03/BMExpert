...
<body class="sb-nav-fixed">
    ...
    <style>
        ...
        .button-container div>select {
            ...
            color: white;
            /* Initial text color for better visibility */
            border-radius: 4px;
            /* Rounded corners */
            height: 40px;
            /* Uniform height */
            width: auto;
            /* Auto width to accommodate content */
        }

        .button-container>div>select {
            background-color: transparent;
            /* Specific background for select */
            color: #086972;
        ...
        .button-container button:hover {
            ...
            border-color: black;
            /* Border color changes to black on hover */
            color: white;
        ...
        .card-header {
            background-color: rgba(6, 79, 92, 0.9);
            /* Semi-transparent version of #064f5c */
            font-weight: bold;
            /* Makes the text bold */
            color: white;
    ...
    <div class="content-area" style="width: 100%; text-align: center; margin-top: 20px;">
        <div class="dropdown-area" style="margin-bottom: 20px;">
            <div class="button-container">
                <button id="leftBtn" class="btn">Per Month</button>
                <div style="display: flex; align-items: center;"> <!-- Use Flexbox for alignment -->
                    <button type="button" class="btn" onclick="window.location.href='dashboard_admin_reports.php';">
                        <i class="fas fa-arrow-left"></i>
                    </button>
                    <select name="year" id="yearSelect" style="margin: 0 10px; align-self: center;"> <!-- Additional CSS for spacing and alignment -->
                        <?php
    ...
    <script>
        document.getElementById("leftBtn").addEventListener("click", function() {
            window.location.href = 'dashboard_admin_statistics.php';
        });
        document.getElementById("rightBtn").addEventListener("click", function() {
            window.location.href = 'dashboard_admin_statistics_year.php';
        });
    </script>
