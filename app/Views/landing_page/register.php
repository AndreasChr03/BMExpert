            ...
            <div class="col-lg-5">
              <div class="card shadow-lg border-0 rounded-lg mt-2">
                <div class="card-header">
                  ...
                  <span id="message"><?php include("../../Models/registerValid.php") ?></span>
                </div>
                <div class="card-body">
                  <!-- Close (X) Icon -->
                  ...
                  <form class="row g-3 needs-validation" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" novalidate>
                    <div class="col-md-12 form-group">
                      ...
                      <select class="form-select" id="role" name="role" disabled required>
                        ...
                        if (isset($_SESSION['role_id'])) {
                          ...
                          echo "<option>You are not authorized to create an account.</option>";
                        }
                        ?>
                      </select>
                      <?php if (isset($row)) : ?>
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="text" class="form-control" id="validationCustom02" name="surname" value="<?php echo $surname; ?>" required>
                    ...
                    <div class="col-md-8 mb-3"> <!-- You can add mb-3 for spacing if needed -->
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="email" class="form-control" id="validationCustomUsername03" aria-describedby="inputGroupPrepend" name="email" value="<?php echo $email; ?>" required>
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="input-group">
                        <input type="text" class="form-control" id="phone_1" name="phone_1" value="<?php echo $phone_1; ?>" required>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <label for="customerPhone">Secondary Phone (Optional)</label>
                      <div class="input-group">
                        <input type="text" class="form-control" id="phone_2" name="phone_2" value="<?php echo $phone_2; ?>">
                      </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="d-flex align-items-center justify-content-center mt-4 mb-0 w-100">
                      ...
                      <button class="btn btn-primary w-100" id="loginSubmit" name="submit" type="submit" <?php if (!isset($_SESSION['loggedin']) || $_SESSION['role_id'] == 3) echo 'disabled'; ?>>
                        Register
                      </button>
                    </div>
